...
(define all-flags
  #hash([precision . (double fallback)]
        ...
        [rules . (arithmetic polynomials fractions exponents trigonometry hyperbolic numerics complex special bools branches overflow)]))
...
(define default-flags
  #hash([precision . (double fallback)]
        ...
        [rules . (arithmetic polynomials fractions exponents trigonometry hyperbolic complex special bools branches overflow)]))
